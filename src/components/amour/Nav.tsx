...
export function Nav({
  ...
  return (
    <nav className="fixed inset-x-0 bottom-4 md:bottom-6 z-40 px-4 pointer-events-none" aria-label="Main navigation">
      <div className="mx-auto flex w-full max-w-[420px] items-center justify-between rounded-full border border-white/15 bg-white/[0.075] p-1.5 shadow-[0_22px_70px_-28px_rgba(0,0,0,0.95)] backdrop-blur-2xl backdrop-saturate-150 pointer-events-auto">
          ...
          return (
            <button
              ...
              className={`min-h-12 flex-1 rounded-full px-3 text-xs font-medium transition-all duration-300 grid place-items-center ${
                active
                  ? "bg-white text-black shadow-[0_12px_32px_-18px_rgba(255,255,255,0.8)]"
